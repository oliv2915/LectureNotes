...
- It is an access point to the server, what we call and 'endpoint'
...
2. The URL that we will fetch from, including a specifi endpoint
...
6. The callback will console.log or pass on the JSON-ified results
7. The third callback function, our error handing function
8. console.log the error if one is found
*/
...
const rocketTable = document.querySelector("table");

searchForm.addEventListener("submit", (event) => fetchSpace(event));
...
function displayRockets(rockets) {
    ...
    rocketTable.style.border = "solid 1px black";
    ...
    let spaceCars = rockets.forEach(r => {
        ...
        rocketTable.appendChild(rocket);
